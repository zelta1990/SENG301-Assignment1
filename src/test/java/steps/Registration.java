...
public class Registration {
     ...
     * @throws SQLException if any error occurred regarding database
     */
    public static List viewVehicles(Connection connection, boolean loggedIn)throws SQLException{
        ...
        while(vehicleSet.next()){
            plates.add(vehicleSet.getString(1));
     ...
     * @param connection a non-null connection to the database
     * @param email
     * @return owner with the given email
     * @throws SQLException if any error occurred regarding database
     */
    public static ResultSet retrieveOwner(Connection connection, String email) throws SQLException{
        assert null != connection;
        PreparedStatement check_statement = connection.prepareStatement("select * from OWNER where EMAIL = ? ");
        check_statement.setString(1, email);
        ResultSet resultSet = check_statement.executeQuery();
        return resultSet;
    }
     ...
     * @param connection a non-null connection to the database
     * @param plate
     * @return vehicle with the given plate
     * @throws SQLException if any error occurred regarding database
     */
    public static ResultSet retrieveVehicle(Connection connection, String plate) throws SQLException{
        assert null != connection;
     ...
     * @throws SQLException if any error occurred regarding database
     */
    public static String insertOwner(Connection connection, String fname, String lname, String email, String pword) throws SQLException{
        assert null != connection;
     ...
     * @throws SQLException if any error occured regarding the database
     */
    public static String registerVehicle(Connection connection, String plate, String vtype, String ftype, String mdate, String make, String model, String email) throws SQLException{
        boolean continueAdd = false;
        ...
        String result = make + " " + model + " of plate " + plate + " is successfully registered.";
     ...
     * @throws SQLException if any error occured regarding the database
     */
    public static String readOwner(Connection connection) throws SQLException{
        String result = "";
        //create a scanner to read the command-line input
        Scanner scanner = new Scanner(System.in);
